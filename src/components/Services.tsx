        ...
        <div className="grid md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group relative bg-slate-50 rounded-[2rem] p-8 md:p-10 border border-slate-100 hover:border-primary/30 transition-all duration-500 overflow-hidden"
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="mt-auto flex items-center text-primary font-semibold group-hover:translate-x-2 transition-transform duration-300 cursor-pointer">
